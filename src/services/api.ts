...
const mockSubscriptions: Subscription[] = [
  { id: 'sub_1', customerId: 'cus_1', customerName: 'Acme Corp', customerEmail: 'billing@acme.com', productId: 'prod_2', productName: 'Professional Plan', status: 'active', amount: 99, currency: 'USD', interval: 'month', currentPeriodStart: '2024-12-01T00:00:00Z', currentPeriodEnd: '2025-01-01T00:00:00Z', createdAt: '2024-06-01T00:00:00Z' },
  { id: 'sub_2', customerId: 'cus_1', customerName: 'Acme Corp', customerEmail: 'billing@acme.com', productId: 'prod_4', productName: 'API Access', status: 'active', amount: 49, currency: 'USD', interval: 'month', currentPeriodStart: '2024-12-01T00:00:00Z', currentPeriodEnd: '2025-01-01T00:00:00Z', createdAt: '2024-07-15T00:00:00Z' },
  { id: 'sub_3', customerId: 'cus_2', customerName: 'TechStart Inc', customerEmail: 'finance@techstart.io', productId: 'prod_1', productName: 'Starter Plan', status: 'active', amount: 29, currency: 'USD', interval: 'month', currentPeriodStart: '2024-12-05T00:00:00Z', currentPeriodEnd: '2025-01-05T00:00:00Z', createdAt: '2024-03-05T00:00:00Z' },
  { id: 'sub_4', customerId: 'cus_3', customerName: 'Global Solutions', customerEmail: 'accounts@globalsol.com', productId: 'prod_3', productName: 'Enterprise Plan', status: 'active', amount: 299, currency: 'USD', interval: 'month', currentPeriodStart: '2024-12-10T00:00:00Z', currentPeriodEnd: '2025-01-10T00:00:00Z', createdAt: '2024-01-20T00:00:00Z' },
  { id: 'sub_5', customerId: 'cus_4', customerName: 'StartupXYZ', customerEmail: 'hello@startupxyz.com', productId: 'prod_1', productName: 'Starter Plan', status: 'past_due', amount: 29, currency: 'USD', interval: 'month', currentPeriodStart: '2024-11-15T00:00:00Z', currentPeriodEnd: '2024-12-15T00:00:00Z', createdAt: '2024-08-15T00:00:00Z' },
  { id: 'sub_6', customerId: 'cus_5', customerName: 'Enterprise Ltd', customerEmail: 'billing@enterprise.co', productId: 'prod_3', productName: 'Enterprise Plan', status: 'active', amount: 3588, currency: 'USD', interval: 'year', currentPeriodStart: '2024-06-01T00:00:00Z', currentPeriodEnd: '2025-06-01T00:00:00Z', createdAt: '2024-06-01T00:00:00Z' },
];

const mockInvoices: Invoice[] = [
  { id: 'inv_1', customerId: 'cus_1', customerName: 'Acme Corp', customerEmail: 'billing@acme.com', amount: 148, currency: 'USD', status: 'paid', dueDate: '2024-12-15T00:00:00Z', paidAt: '2024-12-10T14:30:00Z', createdAt: '2024-12-01T00:00:00Z', items: [{ id: 'ii_1', description: 'Professional Plan - December', quantity: 1, unitPrice: 99, amount: 99 }, { id: 'ii_2', description: 'API Access - December', quantity: 1, unitPrice: 49, amount: 49 }] },
  { id: 'inv_2', customerId: 'cus_2', customerName: 'TechStart Inc', customerEmail: 'finance@techstart.io', amount: 29, currency: 'USD', status: 'paid', dueDate: '2024-12-20T00:00:00Z', paidAt: '2024-12-18T09:00:00Z', createdAt: '2024-12-05T00:00:00Z', items: [{ id: 'ii_3', description: 'Starter Plan - December', quantity: 1, unitPrice: 29, amount: 29 }] },
  { id: 'inv_3', customerId: 'cus_3', customerName: 'Global Solutions', customerEmail: 'accounts@globalsol.com', amount: 299, currency: 'USD', status: 'open', dueDate: '2025-01-10T00:00:00Z', createdAt: '2024-12-10T00:00:00Z', items: [{ id: 'ii_4', description: 'Enterprise Plan - January', quantity: 1, unitPrice: 299, amount: 299 }] },
  { id: 'inv_4', customerId: 'cus_4', customerName: 'StartupXYZ', customerEmail: 'hello@startupxyz.com', amount: 29, currency: 'USD', status: 'open', dueDate: '2024-12-30T00:00:00Z', createdAt: '2024-12-15T00:00:00Z', items: [{ id: 'ii_5', description: 'Starter Plan - December', quantity: 1, unitPrice: 29, amount: 29 }] },
  { id: 'inv_5', customerId: 'cus_5', customerName: 'Enterprise Ltd', customerEmail: 'billing@enterprise.co', amount: 3588, currency: 'USD', status: 'paid', dueDate: '2024-06-15T00:00:00Z', paidAt: '2024-06-10T11:00:00Z', createdAt: '2024-06-01T00:00:00Z', items: [{ id: 'ii_6', description: 'Enterprise Plan - Annual', quantity: 1, unitPrice: 3588, amount: 3588 }] },
];
